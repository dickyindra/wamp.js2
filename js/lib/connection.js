...
export class Connection {
    constructor(options) {
        ...
        // maximum miliseconds connection to websocket server
        self._timeout = self._options.timeout || 30000;

        // when connection to websocket server, this is the timer object return from setTimeout()
